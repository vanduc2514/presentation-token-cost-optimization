...
const customCss = `
  <style>
    ...
    #step-10, #step-11, #step-12, #step-13, #step-14, #step-15, #step-16, #step-17, #step-18, #step-19, #step-20 { --group-accent: #a855f7; }
    #step-21 { --group-accent: #f59e0b; }
    ...
    #step-21 tbody tr:nth-child(1) img {
      width: 180px;
      height: 180px;
      object-fit: contain;
      display: block;
    ...
    #step-21 tbody tr:nth-child(2) img {
      width: 36px;
      height: 36px;
      object-fit: contain;
      display: block;
